...
(async function () {
    try {
        ...
        table.create = true;
        table.columns.add('address', sql.VarChar(255))
        table.columns.add('city', sql.VarChar(255))
        table.columns.add('description', sql.VarChar(255))
        table.columns.add('hotelName', sql.VarChar(255))
        table.columns.add('images', sql.VarChar(255))
